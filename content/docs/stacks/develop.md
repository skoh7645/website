...
The Appsody CLI uses the `Dockerfile` to create the application container image when the [`appsody build`](/content/docs/reference/cli-commands/#appsody-build) command is run.
